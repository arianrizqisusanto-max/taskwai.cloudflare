        ...
        {showLoginModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            >
              ...
              {/* Clean Custom Google Sign-in Button with Invisible GSI Overlay */}
              <div className="flex flex-col items-center justify-center py-1">
                <div className="relative w-full max-w-[280px]">
                  {/* Visible Clean React Button */}
                  <div className="w-full py-3 px-5 rounded-full bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-600 text-zinc-700 dark:text-zinc-200 font-bold text-[13px] flex items-center justify-center gap-3 shadow-sm">
                  ...
                  {/* Invisible GSI Button Overlay */}
                  <div 
                    id="bigboss-modal-google-signin-button" 
                    className="absolute inset-0 opacity-0 cursor-pointer overflow-hidden flex items-center justify-center pointer-events-auto"
                  />
                </div>
              </div>
