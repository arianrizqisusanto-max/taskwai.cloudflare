        ...
        {showLoginModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            >
              ...
              {/* Custom Google Sign-in Button (clean, no pre-populated account) */}
              <div className="flex flex-col items-center justify-center py-1">
                <button
                  type="button"
                  onClick={handleTriggerGoogleLogin}
                  className="w-full max-w-[280px] py-3 px-5 rounded-full bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-600 hover:bg-zinc-50 dark:hover:bg-zinc-750 text-zinc-700 dark:text-zinc-200 font-bold text-[13px] flex items-center justify-center gap-3 shadow-sm transition-all cursor-pointer hover:shadow-md focus:outline-none"
                >
